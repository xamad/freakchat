...
// Hardware vendor - use DIY_V1 for custom builds
...
// Uses meshtastic ST7789Spi library (not TFTDisplay/LovyanGFX)
#define USE_ST7789
...
#define ST7789_MISO     -1          // Not used
#define ST7789_BUSY     -1          // Not used
#define ST7789_SPI_HOST SPI3_HOST   // VSPI
...
// Backlight control
#define VTFT_LEDA       40          // Backlight PWM pin
#define VTFT_CTRL       40          // Power control (same as backlight)
#define TFT_BACKLIGHT_ON HIGH

// Display dimensions (native is 240x320, but we use landscape)
#define TFT_HEIGHT      240
#define TFT_WIDTH       320
#define TFT_OFFSET_X    0
#define TFT_OFFSET_Y    0

// Display rotation and settings
...
// ==================== SPI Configuration ====================
// We use two SPI buses: SPI2 for LoRa, SPI3 for Display
